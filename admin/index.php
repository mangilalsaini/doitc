                                        ...
                                        <div class="col mr-2">
                                            ...
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                                <?php
                                                    ...
                                                    $user_active = mysqli_num_rows($result);
                                                    echo $user_active;
                                                ?>
                                            </div>
                                        </div>
                                        <div class="col-auto">
                                          <!--  <img src="images/user_all.png" width="40px" height="40px"/> -->
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-info text-uppercase mb-1">
                                                <label style="color:red">USERS COUNT(Inactive)</label>
                                            </div>
                                                <div class="row no-gutters align-items-center">
                                                    <div class="col-auto">
                                            ...
                                            <div class="col-auto">
                                                <!--     <img src="images/user_active.png" width="40px" height="40px"/>
                                                <i class="fas fa-users" aria-hidden="true"></i>   -->
                                                <i class="fas fa-solid fa-users-slash fa-2x text-blue-300" aria-hidden="true"></i>
                                            </div>
                                        </div>
                                    </div>
                                </div>
